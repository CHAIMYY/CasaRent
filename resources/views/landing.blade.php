...
<div class="bg-white">
      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-14 w-auto" src="{{ asset('images/logo.png') }}" alt="">
          </a>
        </div>
  ...
  <div class="flex flex-row">  
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8 basis-1/2">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">The premier destination for renting your dream home.</h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">Discover the ultimate platform for finding your ideal rental home, offering unparalleled convenience and an extensive selection to suit your needs.</p>
   ...
   <div class="relative isolate px-6 pt-14 lg:px-8 basis-1/2 mt-20">
...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  <video  class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center brightness-50" autoplay loop muted> 
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Unlock the key to flexible living with our rental options tailored just for you!</h2>
