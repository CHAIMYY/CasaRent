        ...
        <div class=" h-screen">
            <div class="flex border border-grey rounded shadow-lg h-full">
                ...
                <div class="w-2/3 border flex flex-col">
                    ...
                    <!-- Messages -->
                    <div class="flex-1 overflow-auto "bg-gradient-to-r from-cyan-100 to-blue-200" style="background-color: #DAD3CC">
                        <div class="py-2 px-3">
                            ...
                            <div class="flex justify-end mb-2">
                                <div class="rounded py-2 px-3" style="background-color: #0b7fe4">
                                    <p class="text-sm mt-1">
                                        Hi guys.
                                    </p>
                                    <p class="text-right text-xs text-grey-dark mt-1">
